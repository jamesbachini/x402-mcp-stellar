...
// --- READ-ONLY TOOLS ---
server.registerTool('loadPoolData', {
...
server.registerTool("getTokenBalance", {
...
server.registerTool("getFeeStats", {
    title: "Get Fee Stats",
...
server.registerTool('getPoolEvents', {
...
}, async ({ poolId, version, startLedger }) => {
...
server.registerTool('loadBackstopData', {
...
server.registerTool('loadTokenMetadata', {
...
server.registerTool('simulateOperation', {
...
}, async ({ operationXdr, userAddress }) => {
...
server.registerTool('createPool', {
...
server.registerTool('addReserve', {
